...
def main(args):
    ...
    directory.mkdir(exist_ok=True)
    #passed arguments
    #____________________arguments parsing
    ...
    #___________________Model's architecture
    ...
    if save_weights:
        cp_callback.append( tf.keras.callbacks.ModelCheckpoint(checkpoint_path, 
                                                        ...
                                                        verbose=verbose))
    #_____________________Training the model
    if args.is_train:
    ...
    #____________________Saving predicitons of train dataset
    ...
    if save_train_prediction <= num_samples:
        ...
        input_ks, ground_truth = load_data(num_test_samples,'test')
